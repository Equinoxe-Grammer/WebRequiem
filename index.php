...
<body>
    ...
    <header>
        <div class="contenido">
            ...
            <a href="publicaciones.html"><button class="btn-ini">Ver publicaciones</button></a>
        </div>
    ...
    <body>
      ...
      <footer>
        ...
        <div class="botonrepo">
        <a href="Reportes.html"><button class="btn first"><img src="img/reporte logo.png" alt="" width="20px"> Reportes</button></a>
        </div>
      </footer>
</body>
</html>